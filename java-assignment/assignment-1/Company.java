...
/**
 * The Company class represents a company with various attributes such as company number, name, ranking,
 * share prices, products or services, and headquarters.
 */
public class Company {
    ...
    /**
     * Current ranking in the chosen stock exchange – 1 for top of the list and 100 for the bottom of the list.
     */
    int ranking;
    ...
    /**
     * Company Product or Service – between 2 and 5 values which describe the product or service,
 ...
 /**
     ...
     * @param ranking          The current ranking of the company in the stock exchange.
     * @param productsOrServices An array of strings representing the products or services offered by the company.
     * @param hq               The headquarters of the company.
     */    
public Company(int number, Name name, double[] sharePriceData, int ranking, String[] productsOrServices, String hq)// constructor implementation
{
...
// Getters and Setters methods for the instance variables are provided here.

    /**
     * Calculates and returns the average share price based on the given share prices array.
     *
 ...
 */
    public String getFullDetails(Company company) {
        ...
        details.append("Company Number: ").append(String.format("%03d", company.getCompanyNo())).append(", name ").append(company.getCompName().getFullName()).append(".\n");
